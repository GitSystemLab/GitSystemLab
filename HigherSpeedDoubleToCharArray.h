...
#include <stdlib.h>
	...
	static char* ValueToCharArray(double Value0,int DecimalOrderOrderNumber0,int SetWholeDigitOrderOrderNumber0,
		...
		double AbsoluteValue = (double)0.0;
		double AbsoluteValueWholeDigitOrderPart = (double)0.0;
		double DummyAbsoluteValueWholeDigitOrderPart = (double)0.0;
		double AbsoluteValueDecimalOrderPart = (double)0.0;
		double DummyAbsoluteValueDecimalOrderPart = (double)0.0;
		...
		do{//ValueToCharArrayEndMarker&0
			...
			if(OrderNumberCountStartMarker <= 0){
				...
				if(OriginalOrderType == DecimalOrderOrderNumberValueApplicationOrderType){
					...
					if(IntValueBaseErrorMarker == 0){
						if(DummyAbsoluteValueWholeDigitOrderPart < (double)1.0){
							PartialOrderNumberEndMarker = 3;
						}//DummyAbsoluteValueWholeDigitOrderPart&(double)1.0
					}else if(IntValueBaseErrorMarker != 0){
